...
public class Fitness extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.B_mexican:
                ...
                Toast.makeText(Fitness.this, "Showing Nearby Mexican", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_burger:
                ...
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitness.this, "Showing Nearby Burger", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_sushi:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitness.this, "Showing Nearby Sushi", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_ramen:
                ...
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitness.this, "Showing Nearby Ramen", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_indian:
                ...
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitness.this, "Showing Nearby Indian", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_persian:
                ...
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitness.this, "Showing Nearby Persian", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_chinese:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitness.this, "Showing Nearby Chinese", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_italian:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitness.this, "Showing Nearby Italian", Toast.LENGTH_SHORT).show();
                break;
            case R.id.B_randomize:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitness.this, "Showing Nearby " + randomizedDecision, Toast.LENGTH_SHORT).show();
                break;
        }
    }
