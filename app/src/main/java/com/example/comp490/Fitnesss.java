...
public class Fitnesss extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.B_aerobic:
                mMap.clear();
                String url = getUrl(latitude, longitude, "aerobic");
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitnesss.this, "Showing Nearby Aerobic", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_gym:
                ...
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitnesss.this, "Showing Nearby Gym", Toast.LENGTH_SHORT).show();
                break;

            case R.id.B_swimming:
                mMap.clear();
                url = getUrl(latitude, longitude, "swimming");
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;

                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitnesss.this, "Showing Nearby Swimming", Toast.LENGTH_SHORT).show();
                break;

            case R.id.B_tennis:
                mMap.clear();
                url = getUrl(latitude, longitude, "tennis");
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitnesss.this, "Showing Nearby Tennis", Toast.LENGTH_SHORT).show();
                break;

            case R.id.B_pingpong:
                mMap.clear();
                url = getUrl(latitude, longitude, "pingpong");
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitnesss.this, "Showing Nearby Ping Pong", Toast.LENGTH_SHORT).show();
                break;


            case R.id.B_basketball:
                mMap.clear();
                url = getUrl(latitude, longitude, "basketball");
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitnesss.this, "Showing Nearby Basketball", Toast.LENGTH_SHORT).show();
                break;
            case R.id.B_randomize:
                mMap.clear();
                String[] listRandom = new String[]{"aerobic", "gym", "swimming", "tennis", "pingpong", "basketball"};
                Random r = new Random();
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Fitnesss.this, "Showing Nearby " + randomizedDecision, Toast.LENGTH_SHORT).show();
                break;
        }
    }
